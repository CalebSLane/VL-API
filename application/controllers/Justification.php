 ...
 *
 */
class Justification extends MY_Controller {
    
    private $table_alias_map = array("county" => "vl_county_justification", "national" => "vl_national_justification",
        "partner" => "vl_partner_justification", "facility" => "vl_site_justification", "subcounty" => "vl_subcounty_justification");
